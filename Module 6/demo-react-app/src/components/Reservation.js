...
function Reservation() {
    ...
    const handleSubmit = (e) => {
        ...
        alert(`${name} is ${isGoing ? '' : 'not '}attending ${eventName} on ${eventDate} and they're attending with ${numGuests} guests.`)
    }
    ...
    return (
        <form onSubmit={handleSubmit} className="Reservation componentBox">
            ...
            <label>
                Event Date:
                <input name="eventDate" type="text" value={eventDate} onChange={(e) => setEventDate(e.target.value)} />
            </label>
            <label>
                Name:
